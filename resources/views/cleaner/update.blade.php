...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{ route('cleaner.putEditCleaner', $cleaner->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="phone_number" name="phone_number"
                                               value="{{ $cleaner->user->phone_number ?? '' }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="identification"
                                               name="identification" value="{{ $cleaner->user->identification ?? '' }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="temporary_residence_address"
                                               name="temporary_residence_address"
                                               value="{{ $cleaner->temporary_residence_address ?? '' }}"
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <textarea class="form-control" id="cv" rows="5" name="cv">{{ $cleaner->cv ?? '' }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group mt-4">
